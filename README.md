...
- Replaces direct resistance controls with a focused 1–24 virtual shifting interface whenever Zwift Click V2 is paired or a terrain workout is selected. With Click paired, shifting becomes available once the trainer and both controllers are connected; without Click, terrain workouts retain virtual shifting through the on-screen minus/plus buttons and keyboard down/up arrows as soon as the trainer is connected. These controls step through the 24 physical combinations of 39/53-tooth chainrings and a 12-speed 12–24-tooth cassette, sorted by actual drivetrain ratio rather than equal percentage intervals. This gives gear 24 the full 53/12 top end for pushing on descents while retaining 39/24 as gear 1 for climbing. Holding a shift control continues shifting, terrain changes remain smoothly automated underneath the selected gear, and sessions record both the selected gear and applied trainer resistance.
